...
tenDq_3d_nc = $10Dq(3d)_nc_value * $10Dq(3d)_nc_scaling
tenDq_Ld_nc = $10Dq(Ld)_nc_value * $10Dq(Ld)_nc_scaling
Veg_nc      = $V(eg)_nc_value * $V(eg)_nc_scaling
Vt2g_nc     = $V(t2g)_nc_value * $V(t2g)_nc_scaling
...
H_lf_nc = tenDq_3d_nc * tenDq_3d
        + tenDq_Ld_nc * tenDq_Ld
        + Veg_nc      * Veg
        + Vt2g_nc     * Vt2g
