...
F2_2p_3d_fs = $F2(2p,3d)_fs
G1_2p_3d_fs = $G1(2p,3d)_fs
G3_2p_3d_fs = $G3(2p,3d)_fs
F0_2p_3d_fs = U_2p_3d_fs + 1 / 15 * G1_2p_3d_fs + 3 / 70 * G3_2p_3d_fs
e_2p_fs    = (10 * Delta_fs + (1 + NElectrons_3d) * (NElectrons_3d * U_3d_3d_fs / 2 - (10 + NElectrons_3d) * U_2p_3d_fs)) / (16 + NElectrons_3d)
e_3d_fs    = (10 * Delta_fs - NElectrons_3d * (31 + NElectrons_3d) * U_3d_3d_fs / 2 - 90 * U_2p_3d_fs) / (16 + NElectrons_3d)
e_Ld_fs    = ((1 + NElectrons_3d) * (NElectrons_3d * U_3d_3d_fs / 2 + 6 * U_2p_3d_fs) - (6 + NElectrons_3d) * Delta_fs) / (16 + NElectrons_3d)
...
GroundStateRestrictions = {NFermions, NBosons, {'111111 0000000000 0000000000', NElectrons_2p, NElectrons_2p},
...
OppList = {H_gs, OppSsqr, OppLsqr, OppJsqr, OppSz, OppLz, OppN_2p, OppN_3d, OppN_Ld}
...
for j = 1, NPsis do
    ...
    Z = Z + dZ
    Spectrum = Spectrum + CreateSpectra(H_fs, {OppTx_2p_3d, OppTy_2p_3d, OppTz_2p_3d}, Psis[j], {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}}) * dZ
end
