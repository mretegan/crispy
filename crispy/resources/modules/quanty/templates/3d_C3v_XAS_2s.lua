...
for i, spectrum in ipairs(spectra) do
    if spectrum == 'Isotropic' then
        indices = indices_2s_3d[spectrum]
        Giso_2s_3d = GetSpectrum(G_2s_3d, T_2s_3d, Psis_i, indices, dZ_2s_3d)
        SaveSpectrum(Giso_2s_3d, 15, 'iso')
    elseif spectrum == 'Circular Dichroism' then
        indices = indices_2s_3d[spectrum]
        Gr_2s_3d = GetSpectrum(G_2s_3d, T_2s_3d, Psis_i, indices[1], dZ_2s_3d)
        Gl_2s_3d = GetSpectrum(G_2s_3d, T_2s_3d, Psis_i, indices[2], dZ_2s_3d)
        SaveSpectrum(Gr_2s_3d, 1, 'r')
        SaveSpectrum(Gl_2s_3d, 1, 'l')
        SaveSpectrum(Gr_2s_3d - Gl_2s_3d, 1, 'cd')
    elseif spectrum == 'Linear Dichroism' then
        indices = indices_2s_3d[spectrum]
        Gv_2s_3d = GetSpectrum(G_2s_3d, T_2s_3d, Psis_i, indices[1], dZ_2s_3d)
        Gh_2s_3d = GetSpectrum(G_2s_3d, T_2s_3d, Psis_i, indices[2], dZ_2s_3d)
        SaveSpectrum(Gv_2s_3d, 1, 'v')
        SaveSpectrum(Gh_2s_3d, 1, 'h')
        SaveSpectrum(Gv_2s_3d - Gh_2s_3d, 1, 'ld')
    end
end
