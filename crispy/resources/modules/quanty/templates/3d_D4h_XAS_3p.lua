...
NUp_3p = NewOperator('Number', NFermions, IndexUp_3p, IndexUp_3p, {1, 1, 1})
NDn_3p = NewOperator('Number', NFermions, IndexDn_3p, IndexDn_3p, {1, 1, 1})
N_3p   = NUp_3p + NDn_3p
...
U_3p_3d_fc  = $U(3p,3d)_fc_value * $U(3p,3d)_fc_scaling
F2_3p_3d_fc = $F2(3p,3d)_fc_value * $F2(3p,3d)_fc_scaling
G1_3p_3d_fc = $G1(3p,3d)_fc_value * $G1(3p,3d)_fc_scaling
G3_3p_3d_fc = $G3(3p,3d)_fc_value * $G3(3p,3d)_fc_scaling
...
H_coulomb_fc = F0_3d_3d_fc * F0_3d_3d
             ...
             + F0_3p_3d_fc * F0_3p_3d
             + F2_3p_3d_fc * F2_3p_3d
             + G1_3p_3d_fc * G1_3p_3d
             + G3_3p_3d_fc * G3_3p_3d
             + e_3p_fc     * N_3p
             + e_3d_fc     * N_3d
             + e_Ld_fc     * N_Ld
...
zeta_3p_fc = $zeta(3p)_fc_value * $zeta(3p)_fc_scaling
...
Operators = {H_ic, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, N_3p, N_3d, N_Ld}
