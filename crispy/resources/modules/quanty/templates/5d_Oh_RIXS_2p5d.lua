...
if H_atomic == 1 then
    ...
    U_5d_5d_m  = $U(5d,5d)_m_value * $U(5d,5d)_m_scaling
    ...
    U_2p_5d_m  = $U(2p,5d)_m_value * $U(2p,5d)_m_scaling
...
if H_cf == 1 then
    ...
    tenDq_5d_m = $10Dq(5d)_m_value * $10Dq(5d)_m_scaling
...
if H_5d_Ld_hybridization == 1 then
    ...
    Delta_5d_Ld_m = $Delta(5d,Ld)_m_value * $Delta(5d,Ld)_m_scaling
    ...
    Veg_5d_Ld_m  = $Veg(5d,Ld)_m_value * $Veg(5d,Ld)_m_scaling
    Vt2g_5d_Ld_m = $Vt2g(5d,Ld)_m_value * $Vt2g(5d,Ld)_m_scaling
...
for i, Psi in ipairs(Psis) do
    ...
    Z = Z + dZ
    for j, OperatorIn in ipairs({Tx_2p_5d, Ty_2p_5d, Tz_2p_5d}) do
        for k, OperatorOut in ipairs({Tx_5d_2p, Ty_5d_2p, Tz_5d_2p}) do
