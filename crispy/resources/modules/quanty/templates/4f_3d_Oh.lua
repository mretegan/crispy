...
Tk1_3d_4f = k1[1] * Tx_3d_4f + k1[2] * Ty_3d_4f + k1[3] * Tz_3d_4f
Teps11_3d_4f = eps11[1] * Tx_3d_4f + eps11[2] * Ty_3d_4f + eps11[3] * Tz_3d_4f
Teps12_3d_4f = eps12[1] * Tx_3d_4f + eps12[2] * Ty_3d_4f + eps12[3] * Tz_3d_4f

Tr_3d_4f =  t * (Teps11_3d_4f - I * Teps12_3d_4f)
Tl_3d_4f = -t * (Teps11_3d_4f + I * Teps12_3d_4f)
...
if SingleCrystalSample == 1 then
    ...
    elseif Experiment == 'X(M)LD' then
        T_3d_4f = {Teps11_3d_4f, Teps12_3d_4f}
    elseif Experiment == 'XMCD' then
        T_3d_4f = {Tr_3d_4f, Tl_3d_4f}
    else
        return
    end
else
...
if CalculationRestrictions == nil then
    G = CreateSpectra(H_f, T_3d_4f, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}})
else
    G = CreateSpectra(H_f, T_3d_4f, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'restrictions', CalculationRestrictions}})
end
