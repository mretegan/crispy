...
if H_4f_ligands_hybridization == 1 then
    ...
    IndexDn_Lf = {20, 22, 24, 26, 28, 30, 32}
    IndexUp_Lf = {21, 23, 25, 27, 29, 31, 33}
end
...
if H_4f_ligands_hybridization == 1 then
    ...
    e_4f_f = (28*Delta_4f_Lf_f - U_4f_4f_f*NElectrons_4f^2 - 39*U_4f_4f_f*NElectrons_4f - 228*U_4p_4f_f)/(2*(NElectrons_4f + 20))
    e_4p_f = (28*Delta_4f_Lf_f + U_4f_4f_f*NElectrons_4f^2 + U_4f_4f_f*NElectrons_4f - 2*U_4p_4f_f*NElectrons_4f^2 - 30*U_4p_4f_f*NElectrons_4f - 28*U_4p_4f_f)/(2*(NElectrons_4f + 20))
    e_Lf_f = (-2*Delta_4f_Lf_f*NElectrons_4f - 12*Delta_4f_Lf_f + U_4f_4f_f*NElectrons_4f^2 + U_4f_4f_f*NElectrons_4f + 12*U_4p_4f_f*NElectrons_4f + 12*U_4p_4f_f)/(2*(NElectrons_4f + 20))
...
if H_4f_ligands_hybridization == 1 then
    InitialRestrictions = {NFermions, NBosons, {'111111 00000000000000 00000000000000', NElectrons_4p, NElectrons_4p},
                                               ...
                                               {'000000 00000000000000 11111111111111', NElectrons_Lf, NElectrons_Lf}}
    ...
    CalculationRestrictions = {NFermions, NBosons, {'000000 00000000000000 11111111111111', NElectrons_Lf - (NConfigurations - 1), NElectrons_Lf}}
end

Operators = {H_i, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, Tz, ldots_4f, N_4p, N_4f, 'dZ'}
...
if H_4f_ligands_hybridization == 1 then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, Tz, ldots_4f, N_4p, N_4f, N_Lf, 'dZ'}
    header = 'Analysis of the initial Hamiltonian:\n'
    header = header .. '===========================================================================================================================================\n'
    header = header .. 'State         <E>     <S^2>     <L^2>     <J^2>      <Sz>      <Lz>      <Jz>      <Tz>     <l.s>    <N_4p>    <N_4f>    <N_Lf>          dZ\n'
    header = header .. '===========================================================================================================================================\n'
    footer = '===========================================================================================================================================\n'
end
