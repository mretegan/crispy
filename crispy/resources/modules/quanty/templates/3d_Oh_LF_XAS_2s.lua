...
U_2s_3d_fc  = $U(2s,3d)_fc
G2_2s_3d_fc = $G2(2s,3d)_fc
...
H_coulomb_fc = F0_3d_3d_fc * OppF0_3d_3d
             ...
             + F0_2s_3d_fc * OppF0_2s_3d
             + G2_2s_3d_fc * OppG2_2s_3d
             + e_2s_fc     * OppN_2s
             + e_3d_fc     * OppN_3d
             + e_Ld_fc     * OppN_Ld
...
OppList = {H_sc, OppSsqr, OppLsqr, OppJsqr, OppSz, OppLz, OppN_2s, OppN_3d, OppN_Ld}
...
for j = 1, NPsis do
    ...
    Z = Z + dZ
    G = G + CreateSpectra(H_fc, {OppTxy_2s_3d, OppTxz_2s_3d, OppTyz_2s_3d, OppTx2y2_2s_3d, OppTz2_2s_3d}, Psis[j], {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}}) * dZ
end
