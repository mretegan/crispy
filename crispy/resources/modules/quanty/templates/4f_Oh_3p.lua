...
if H_atomic == 1 then
    ...
    F2_3p_4f_f = $F2(3p,4f)_f_value * $F2(3p,4f)_f_scaling
    G2_3p_4f_f = $G2(3p,4f)_f_value * $G2(3p,4f)_f_scaling
    G4_3p_4f_f = $G4(3p,4f)_f_value * $G4(3p,4f)_f_scaling
    F0_3p_4f_f = 3 / 70 * G2_3p_4f_f + 2 / 63 * G4_3p_4f_f
...
Operators = {H_i, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, N_3p, N_4f, 'dZ'}
header = 'Analysis of the initial Hamiltonian:\n'
header = header .. '=============================================================================================================\n'
header = header .. 'State         <E>     <S^2>     <L^2>     <J^2>      <Sz>      <Lz>      <Jz>    <N_3p>    <N_4f>          dZ\n'
header = header .. '=============================================================================================================\n'
footer = '=============================================================================================================\n'
...
if Experiment == 'XAS' then
    T = {Txy_3p_4f, Txz_3p_4f, Tyz_3p_4f, Tx2y2_3p_4f, Tz2_3p_4f}
