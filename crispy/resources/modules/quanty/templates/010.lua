...
U_1s_3d_fs  = $U(1s,3d)_fs
G2_1s_3d_fs = $G2(1s,3d)_fs
F0_1s_3d_fs = U_1s_3d_fs + 1 / 10 * G2_1s_3d_fs
e_1s_fs = (10 * Delta_fs + (1 + NElectrons_3d) * (NElectrons_3d * U_3d_3d_fs / 2 - (10 + NElectrons_3d) * U_1s_3d_fs)) / (12 + NElectrons_3d)
e_3d_fs = (10 * Delta_fs - NElectrons_3d * (23 + NElectrons_3d) * U_3d_3d_fs / 2 - 22 * U_1s_3d_fs) / (12 + NElectrons_3d)
e_Ld_fs = ((1 + NElectrons_3d) * (NElectrons_3d * U_3d_3d_fs / 2 + 2 * U_1s_3d_fs) - (2 + NElectrons_3d) * Delta_fs) / (12 + NElectrons_3d)
...
GroundStateRestrictions = {NFermions, NBosons, {'11 0000000000 0000000000', NElectrons_1s, NElectrons_1s},
...
OppList = {H_gs, OppSsqr, OppLsqr, OppJsqr, OppSz, OppLz, OppN_1s, OppN_3d, OppN_Ld}
...
for j = 1, NPsis do
    ...
    Z = Z + dZ
    Spectrum = Spectrum + CreateSpectra(H_fs, {OppTxy_1s_3d, OppTxz_1s_3d, OppTyz_1s_3d, OppTx2y2_1s_3d, OppTz2_1s_3d}, Psis[j], {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}}) * dZ
end
