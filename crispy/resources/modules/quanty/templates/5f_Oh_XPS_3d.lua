...
if H_5f_ligands_hybridization == 1 then
    ...
    e_5f_f = (28 * Delta_5f_Lf_f - 460 * U_3d_5f_f - U_5f_5f_f * NElectrons_5f^2 - 47 * U_5f_5f_f * NElectrons_5f) / (2 * (NElectrons_5f + 24))
    e_3d_f = (28 * Delta_5f_Lf_f - 2 * U_3d_5f_f * NElectrons_5f^2 - 30 * U_3d_5f_f * NElectrons_5f - 28 * U_3d_5f_f + U_5f_5f_f * NElectrons_5f^2 + U_5f_5f_f * NElectrons_5f) / (2 * (NElectrons_5f + 24))
    e_Lf_f = (-2 * Delta_5f_Lf_f * NElectrons_5f - 20 * Delta_5f_Lf_f + 20 * U_3d_5f_f * NElectrons_5f + 20 * U_3d_5f_f + U_5f_5f_f * NElectrons_5f^2 + U_5f_5f_f * NElectrons_5f) / (2 * (NElectrons_5f + 24))
...
Operators = {H_i, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, Tz, ldots_5f, N_3d, N_5f, 'dZ'}
...
if H_5f_ligands_hybridization == 1 then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, Tz, ldots_5f, N_3d, N_5f, N_Lf, 'dZ'}
    header = 'Analysis of the initial Hamiltonian:\n'
    header = header .. '===========================================================================================================================================\n'
    header = header .. 'State         <E>     <S^2>     <L^2>     <J^2>      <Sz>      <Lz>      <Jz>      <Tz>     <l.s>    <N_3d>    <N_5f>    <N_Lf>          dZ\n'
    header = header .. '===========================================================================================================================================\n'
    footer = '===========================================================================================================================================\n'
end
