...
Tk1_3d_5f = Chop(k[1] * Tx_3d_5f + k[2] * Ty_3d_5f + k[3] * Tz_3d_5f)
Tv_3d_5f = Chop(ev[1] * Tx_3d_5f + ev[2] * Ty_3d_5f + ev[3] * Tz_3d_5f)
Th_3d_5f = Chop(eh[1] * Tx_3d_5f + eh[2] * Ty_3d_5f + eh[3] * Tz_3d_5f)

Tr_3d_5f = Chop(t * (Th_3d_5f - I * Tv_3d_5f))
Tl_3d_5f = Chop(-t * (Th_3d_5f + I * Tv_3d_5f))
