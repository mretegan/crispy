...
if H_4f_ligands_hybridization == 1 then
    ...
    e_4f_f = (28 * Delta_4f_Lf_f - 460 * U_4d_4f_f - U_4f_4f_f * NElectrons_4f^2 - 47 * U_4f_4f_f * NElectrons_4f) / (2 * (NElectrons_4f + 24))
    e_4d_f = (28 * Delta_4f_Lf_f - 2 * U_4d_4f_f * NElectrons_4f^2 - 30 * U_4d_4f_f * NElectrons_4f - 28 * U_4d_4f_f + U_4f_4f_f * NElectrons_4f^2 + U_4f_4f_f * NElectrons_4f) / (2 * (NElectrons_4f + 24))
    e_Lf_f = (-2 * Delta_4f_Lf_f * NElectrons_4f - 20 * Delta_4f_Lf_f + 20 * U_4d_4f_f * NElectrons_4f + 20 * U_4d_4f_f + U_4f_4f_f * NElectrons_4f^2 + U_4f_4f_f * NElectrons_4f) / (2 * (NElectrons_4f + 24))
...
Operators = {H_i, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, Tz, ldots_4f, N_4d, N_4f, 'dZ'}
...
if H_4f_ligands_hybridization == 1 then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, Tz, ldots_4f, N_4d, N_4f, N_Lf, 'dZ'}
    header = 'Analysis of the initial Hamiltonian:\n'
    header = header .. '===========================================================================================================================================\n'
    header = header .. 'State         <E>     <S^2>     <L^2>     <J^2>      <Sz>      <Lz>      <Jz>      <Tz>     <l.s>    <N_4d>    <N_4f>    <N_Lf>          dZ\n'
    header = header .. '===========================================================================================================================================\n'
    footer = '===========================================================================================================================================\n'
end
