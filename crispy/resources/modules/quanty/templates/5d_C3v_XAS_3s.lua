...
for i, spectrum in ipairs(spectra) do
    if spectrum == 'Isotropic' then
        indices = indices_3s_5d[spectrum]
        Giso_3s_5d = GetSpectrum(G_3s_5d, T_3s_5d, Psis_i, indices, dZ_3s_5d)
        SaveSpectrum(Giso_3s_5d, 15, 'iso')
    elseif spectrum == 'Circular Dichroism' then
        indices = indices_3s_5d[spectrum]
        Gr_3s_5d = GetSpectrum(G_3s_5d, T_3s_5d, Psis_i, indices[1], dZ_3s_5d)
        Gl_3s_5d = GetSpectrum(G_3s_5d, T_3s_5d, Psis_i, indices[2], dZ_3s_5d)
        SaveSpectrum(Gr_3s_5d, 1, 'r')
        SaveSpectrum(Gl_3s_5d, 1, 'l')
        SaveSpectrum(Gr_3s_5d - Gl_3s_5d, 1, 'cd')
    elseif spectrum == 'Linear Dichroism' then
        indices = indices_3s_5d[spectrum]
        Gv_3s_5d = GetSpectrum(G_3s_5d, T_3s_5d, Psis_i, indices[1], dZ_3s_5d)
        Gh_3s_5d = GetSpectrum(G_3s_5d, T_3s_5d, Psis_i, indices[2], dZ_3s_5d)
        SaveSpectrum(Gv_3s_5d, 1, 'v')
        SaveSpectrum(Gh_3s_5d, 1, 'h')
        SaveSpectrum(Gv_3s_5d - Gh_3s_5d, 1, 'ld')
    end
end
