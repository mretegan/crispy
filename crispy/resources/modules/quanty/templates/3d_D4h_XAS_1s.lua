...
U_1s_3d_fc  = $U(1s,3d)_fc_value * $U(1s,3d)_fc_scaling
G2_1s_3d_fc = $G2(1s,3d)_fc_value * $G2(1s,3d)_fc_scaling
...
H_coulomb_fc = F0_3d_3d_fc * F0_3d_3d
             ...
             + F0_1s_3d_fc * F0_1s_3d
             + G2_1s_3d_fc * G2_1s_3d
             + e_1s_fc     * N_1s
             + e_3d_fc     * N_3d
             + e_Ld_fc     * N_Ld
...
Operators = {H_ic, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, N_1s, N_3d, N_Ld}
