...
if MlctLigandsHybridizationTerm then
    ...
    e_L2_m = (2 * Delta_#m_L2_m * NElectrons_#m + 12 * Delta_#m_L2_m - U_#m_#m_m * NElectrons_#m^2 - U_#m_#m_m * NElectrons_#m - 12 * U_#i_#m_m * NElectrons_#m - 12 * U_#i_#m_m) / (2 * (NElectrons_#m + 6))
