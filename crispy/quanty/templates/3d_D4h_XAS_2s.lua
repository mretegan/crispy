...
if LmctLigandsHybridizationTerm then
    ...
    E_3d_f = (10 * Delta_3d_L1_f - NElectrons_3d * (31 + NElectrons_3d) * U_3d_3d_f / 2 - 90 * U_2s_3d_f) / (16 + NElectrons_3d)
    E_2s_f = (10 * Delta_3d_L1_f + (1 + NElectrons_3d) * (NElectrons_3d * U_3d_3d_f / 2 - (10 + NElectrons_3d) * U_2s_3d_f)) / (16 + NElectrons_3d)
    E_L1_f = ((1 + NElectrons_3d) * (NElectrons_3d * U_3d_3d_f / 2 + 6 * U_2s_3d_f) - (6 + NElectrons_3d) * Delta_3d_L1_f) / (16 + NElectrons_3d)
...
if MlctLigandsHybridizationTerm then
    ...
    E_3d_f = -(U_3d_3d_f * NElectrons_3d^2 + 11 * U_3d_3d_f * NElectrons_3d + 60 * U_2s_3d_f) / (2 * NElectrons_3d + 12)
    E_2s_f = NElectrons_3d * (U_3d_3d_f * NElectrons_3d + U_3d_3d_f - 2 * U_2s_3d_f * NElectrons_3d - 2 * U_2s_3d_f) / (2 * (NElectrons_3d + 6))
    E_L2_f = (2 * Delta_3d_L2_f * NElectrons_3d + 12 * Delta_3d_L2_f + U_3d_3d_f * NElectrons_3d^2 - U_3d_3d_f * NElectrons_3d - 12 * U_3d_3d_f + 12 * U_2s_3d_f * NElectrons_3d + 12 * U_2s_3d_f) / (2 * (NElectrons_3d + 6))
...
SpectraAndOperators = {
    ["Isotropic Absorption"] = {Tk_2s_3d, Tr_2s_3d, Tl_2s_3d},
    ["Absorption"] = {Tk_2s_3d,},
