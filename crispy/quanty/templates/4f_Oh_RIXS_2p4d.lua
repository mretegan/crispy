...
if AtomicTerm then
    ...
    HAtomic_i = $zeta(4f)_i_value * ldots_4f
    HAtomic_m = $zeta(4f)_m_value * ldots_4f + $zeta(2p)_m_value * ldots_2p
    HAtomic_f = $zeta(4f)_f_value * ldots_4f + $zeta(4d)_f_value * ldots_4d
end
