...
if LmctLigandsHybridizationTerm then
    ...
    E_5d_f = (10 * Delta_5d_L1_f - NElectrons_5d * (31 + NElectrons_5d) * U_5d_5d_f / 2 - 90 * U_4s_5d_f) / (16 + NElectrons_5d)
    E_4s_f = (10 * Delta_5d_L1_f + (1 + NElectrons_5d) * (NElectrons_5d * U_5d_5d_f / 2 - (10 + NElectrons_5d) * U_4s_5d_f)) / (16 + NElectrons_5d)
    E_L1_f = ((1 + NElectrons_5d) * (NElectrons_5d * U_5d_5d_f / 2 + 6 * U_4s_5d_f) - (6 + NElectrons_5d) * Delta_5d_L1_f) / (16 + NElectrons_5d)
...
if MlctLigandsHybridizationTerm then
    ...
    E_5d_f = -(U_5d_5d_f * NElectrons_5d^2 + 11 * U_5d_5d_f * NElectrons_5d + 60 * U_4s_5d_f) / (2 * NElectrons_5d + 12)
    E_4s_f = NElectrons_5d * (U_5d_5d_f * NElectrons_5d + U_5d_5d_f - 2 * U_4s_5d_f * NElectrons_5d - 2 * U_4s_5d_f) / (2 * (NElectrons_5d + 6))
    E_L2_f = (2 * Delta_5d_L2_f * NElectrons_5d + 12 * Delta_5d_L2_f + U_5d_5d_f * NElectrons_5d^2 - U_5d_5d_f * NElectrons_5d - 12 * U_5d_5d_f + 12 * U_4s_5d_f * NElectrons_5d + 12 * U_4s_5d_f) / (2 * (NElectrons_5d + 6))
