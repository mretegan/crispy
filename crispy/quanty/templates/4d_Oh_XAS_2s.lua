...
if LmctLigandsHybridizationTerm then
    ...
    E_4d_f = (10 * Delta_4d_L1_f - NElectrons_4d * (31 + NElectrons_4d) * U_4d_4d_f / 2 - 90 * U_2s_4d_f) / (16 + NElectrons_4d)
    E_2s_f = (10 * Delta_4d_L1_f + (1 + NElectrons_4d) * (NElectrons_4d * U_4d_4d_f / 2 - (10 + NElectrons_4d) * U_2s_4d_f)) / (16 + NElectrons_4d)
    E_L1_f = ((1 + NElectrons_4d) * (NElectrons_4d * U_4d_4d_f / 2 + 6 * U_2s_4d_f) - (6 + NElectrons_4d) * Delta_4d_L1_f) / (16 + NElectrons_4d)
...
if MlctLigandsHybridizationTerm then
    ...
    E_4d_f = -(U_4d_4d_f * NElectrons_4d^2 + 11 * U_4d_4d_f * NElectrons_4d + 60 * U_2s_4d_f) / (2 * NElectrons_4d + 12)
    E_2s_f = NElectrons_4d * (U_4d_4d_f * NElectrons_4d + U_4d_4d_f - 2 * U_2s_4d_f * NElectrons_4d - 2 * U_2s_4d_f) / (2 * (NElectrons_4d + 6))
    E_L2_f = (2 * Delta_4d_L2_f * NElectrons_4d + 12 * Delta_4d_L2_f + U_4d_4d_f * NElectrons_4d^2 - U_4d_4d_f * NElectrons_4d - 12 * U_4d_4d_f + 12 * U_2s_4d_f * NElectrons_4d + 12 * U_2s_4d_f) / (2 * (NElectrons_4d + 6))
...
SpectraAndOperators = {
    ["Isotropic Absorption"] = {Tk_2s_4d, Tr_2s_4d, Tl_2s_4d},
    ["Absorption"] = {Tk_2s_4d,},
