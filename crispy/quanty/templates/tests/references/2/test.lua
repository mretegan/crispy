...
ExperimentalShift = 8333.0 -- Experimental edge energy (eV).
...
if AtomicTerm then
    ...
    U_3d_3d_f = 0.0
    F2_3d_3d_f = 12.9234 * 0.75
    F4_3d_3d_f = 8.0244 * 0.75
    F0_3d_3d_f = U_3d_3d_f + 2 / 63 * F2_3d_3d_f + 2 / 63 * F4_3d_3d_f
    U_1s_3d_f = 0.0
    G2_1s_3d_f = 0.072 * 0.7
