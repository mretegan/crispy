...
if H_4f_ligands_hybridization_lmct == 1 then
    ...
    E_4f_f = (28 * Delta_4f_L1_f - 460 * U_4p_4f_f - U_4f_4f_f * NElectrons_4f^2 - 47 * U_4f_4f_f * NElectrons_4f) / (2 * (NElectrons_4f + 24))
    E_4p_f = (28 * Delta_4f_L1_f - 2 * U_4p_4f_f * NElectrons_4f^2 - 30 * U_4p_4f_f * NElectrons_4f - 28 * U_4p_4f_f + U_4f_4f_f * NElectrons_4f^2 + U_4f_4f_f * NElectrons_4f) / (2 * (NElectrons_4f + 24))
    E_L1_f = (-2 * Delta_4f_L1_f * NElectrons_4f - 20 * Delta_4f_L1_f + 20 * U_4p_4f_f * NElectrons_4f + 20 * U_4p_4f_f + U_4f_4f_f * NElectrons_4f^2 + U_4f_4f_f * NElectrons_4f) / (2 * (NElectrons_4f + 24))
