...
which can be used to overcome these limitations.

Crystal Field Multiplet
-----------------------
1. Calculate the 2p XAS spectrum of |Ni2+| using the default parameters, but
increase the Gaussian broadening to 0.4 eV. Identify the |L2| and |L3| edges in
the calculated spectrum.

2. Change the default scaling of the Slater integrals (κ) to 0.6, 0.4, and 0.2,
rerunning the calculation for each value. Overlay the four spectra and describe
the evolution of the main peak and its high-energy shoulder when the scaling
...
How do the reduction factor and the covalency of the metal-ligand bond
correlate, knowing that the latter increases with an increasing atomic mass of
the halide?
...
.. figure:: assets/laan_fig1.png
    ...
    van der Laan et al., Phys. Rev. B, 1986, 33 (6), 4253--4263.
...
5. Is there a particular region of the spectrum that does not seem to be
...
eV, U(2p,3d) = 8.5 eV (*Atomic*), 10Dq(3d) = 0.7 eV (*Crystal Field*), Δ(3d,L1)
= 4.3 eV, Veg(3d,L1) = 2.0 eV, Vt2g(3d,L1) = 1.0 eV (*3d-Ligands
Hybridization (LMCT)*). How does the calculated spectrum compare with the
measured spectrum of NiO?

2. Repeat the above calculation while varying Δ between 0.0 and 10.0 eV. Notice
the changes in the number of metal 3d and ligand electrons (<N_3d> and
<N_L1> in the logging window). What happens if Δ is negative?

3. Try to get a better agreement with the experimental spectrum of NiO by
varying the crystal field parameters, 10Dq(3d) and 10Dq(L1), and the hopping
integrals, Veg(3d,L1) and Vt2g(3d,L1).
