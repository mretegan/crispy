...
| |Windows|                        | |macOS|                      | |Linux|                     |
+----------------------------------+------------------------------+-----------------------------+
| `Crispy-0.6.3-x64.exe (64-bit)`_ | `Crispy-0.6.3.dmg (64-bit)`_ | see the :doc:`installation` |
|                                  |                              |                             |
...
.. _Crispy-0.6.3-x64.exe (64-bit): https://github.com/mretegan/crispy/releases/download/v0.6.3/Crispy-0.6.3-x64.exe

.. _Crispy-0.6.3.dmg (64-bit): https://github.com/mretegan/crispy/releases/download/v0.6.3/Crispy-0.6.3.dmg
