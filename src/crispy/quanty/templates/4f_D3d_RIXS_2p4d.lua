...
if CrystalFieldTerm then
    ...
    --
    -- The seven 4f orbitals (l = 3, ungerade) split into a1u + 2 a2u + 2 eu. The
    ...
    Eav_4f_i = ($Ea1u(4f)_i_value + $Ea2uA(4f)_i_value + $Ea2uB(4f)_i_value + 2 * $Eeu1(4f)_i_value + 2 * $Eeu2(4f)_i_value) / 7
    Ea1u_4f_i = $Ea1u(4f)_i_value - Eav_4f_i
    Ea2uA_4f_i = $Ea2uA(4f)_i_value - Eav_4f_i
    Ea2uB_4f_i = $Ea2uB(4f)_i_value - Eav_4f_i
    Eeu1_4f_i = $Eeu1(4f)_i_value - Eav_4f_i
    Eeu2_4f_i = $Eeu2(4f)_i_value - Eav_4f_i
    Ma2u_4f_i = $Ma2u(4f)_i_value
    Meu_4f_i = $Meu(4f)_i_value

    Akm_4f_i = {
        {0, 0, (1 / 7) * (Ea1u_4f_i + Ea2uA_4f_i + Ea2uB_4f_i + 2 * Eeu1_4f_i + 2 * Eeu2_4f_i)},
        {2, 0, (-5 / 28) * (5 * Ea1u_4f_i + 5 * Ea2uA_4f_i - 4 * Ea2uB_4f_i - 6 * Eeu1_4f_i)},
        {4, 0, (3 / 14) * (3 * Ea1u_4f_i + 3 * Ea2uA_4f_i + 2 * (3 * Ea2uB_4f_i + Eeu1_4f_i - 7 * Eeu2_4f_i))},
        {4, 3, (1 / sqrt(14)) * (9 * Ma2u_4f_i + 6 * Meu_4f_i)},
        {4, -3, -3 * (1 / sqrt(14)) * (3 * Ma2u_4f_i + 2 * Meu_4f_i)},
        {6, 0, (-13 / 140) * (Ea1u_4f_i + Ea2uA_4f_i - 20 * Ea2uB_4f_i + 30 * Eeu1_4f_i - 12 * Eeu2_4f_i)},
        {6, 3, (-13 / 5) * (sqrt(3 / 14) * (Ma2u_4f_i - 3 * Meu_4f_i))},
        {6, -3, (13 / 5) * (sqrt(3 / 14) * (Ma2u_4f_i - 3 * Meu_4f_i))},
        {6, -6, (-13 / 20) * (sqrt(33 / 7) * (Ea1u_4f_i - Ea2uA_4f_i))},
        {6, 6, (-13 / 20) * (sqrt(33 / 7) * (Ea1u_4f_i - Ea2uA_4f_i))}
    }
    ...
    Eav_4f_m = ($Ea1u(4f)_m_value + $Ea2uA(4f)_m_value + $Ea2uB(4f)_m_value + 2 * $Eeu1(4f)_m_value + 2 * $Eeu2(4f)_m_value) / 7
    Ea1u_4f_m = $Ea1u(4f)_m_value - Eav_4f_m
    Ea2uA_4f_m = $Ea2uA(4f)_m_value - Eav_4f_m
    Ea2uB_4f_m = $Ea2uB(4f)_m_value - Eav_4f_m
    Eeu1_4f_m = $Eeu1(4f)_m_value - Eav_4f_m
    Eeu2_4f_m = $Eeu2(4f)_m_value - Eav_4f_m
    Ma2u_4f_m = $Ma2u(4f)_m_value
    Meu_4f_m = $Meu(4f)_m_value

    Akm_4f_m = {
        {0, 0, (1 / 7) * (Ea1u_4f_m + Ea2uA_4f_m + Ea2uB_4f_m + 2 * Eeu1_4f_m + 2 * Eeu2_4f_m)},
        {2, 0, (-5 / 28) * (5 * Ea1u_4f_m + 5 * Ea2uA_4f_m - 4 * Ea2uB_4f_m - 6 * Eeu1_4f_m)},
        {4, 0, (3 / 14) * (3 * Ea1u_4f_m + 3 * Ea2uA_4f_m + 2 * (3 * Ea2uB_4f_m + Eeu1_4f_m - 7 * Eeu2_4f_m))},
        {4, 3, (1 / sqrt(14)) * (9 * Ma2u_4f_m + 6 * Meu_4f_m)},
        {4, -3, -3 * (1 / sqrt(14)) * (3 * Ma2u_4f_m + 2 * Meu_4f_m)},
        {6, 0, (-13 / 140) * (Ea1u_4f_m + Ea2uA_4f_m - 20 * Ea2uB_4f_m + 30 * Eeu1_4f_m - 12 * Eeu2_4f_m)},
        {6, 3, (-13 / 5) * (sqrt(3 / 14) * (Ma2u_4f_m - 3 * Meu_4f_m))},
        {6, -3, (13 / 5) * (sqrt(3 / 14) * (Ma2u_4f_m - 3 * Meu_4f_m))},
        {6, -6, (-13 / 20) * (sqrt(33 / 7) * (Ea1u_4f_m - Ea2uA_4f_m))},
        {6, 6, (-13 / 20) * (sqrt(33 / 7) * (Ea1u_4f_m - Ea2uA_4f_m))}
    }

    Eav_4f_f = ($Ea1u(4f)_f_value + $Ea2uA(4f)_f_value + $Ea2uB(4f)_f_value + 2 * $Eeu1(4f)_f_value + 2 * $Eeu2(4f)_f_value) / 7
    Ea1u_4f_f = $Ea1u(4f)_f_value - Eav_4f_f
    Ea2uA_4f_f = $Ea2uA(4f)_f_value - Eav_4f_f
    Ea2uB_4f_f = $Ea2uB(4f)_f_value - Eav_4f_f
    Eeu1_4f_f = $Eeu1(4f)_f_value - Eav_4f_f
    Eeu2_4f_f = $Eeu2(4f)_f_value - Eav_4f_f
    Ma2u_4f_f = $Ma2u(4f)_f_value
    Meu_4f_f = $Meu(4f)_f_value

    Akm_4f_f = {
        {0, 0, (1 / 7) * (Ea1u_4f_f + Ea2uA_4f_f + Ea2uB_4f_f + 2 * Eeu1_4f_f + 2 * Eeu2_4f_f)},
        {2, 0, (-5 / 28) * (5 * Ea1u_4f_f + 5 * Ea2uA_4f_f - 4 * Ea2uB_4f_f - 6 * Eeu1_4f_f)},
        {4, 0, (3 / 14) * (3 * Ea1u_4f_f + 3 * Ea2uA_4f_f + 2 * (3 * Ea2uB_4f_f + Eeu1_4f_f - 7 * Eeu2_4f_f))},
        {4, 3, (1 / sqrt(14)) * (9 * Ma2u_4f_f + 6 * Meu_4f_f)},
        {4, -3, -3 * (1 / sqrt(14)) * (3 * Ma2u_4f_f + 2 * Meu_4f_f)},
        {6, 0, (-13 / 140) * (Ea1u_4f_f + Ea2uA_4f_f - 20 * Ea2uB_4f_f + 30 * Eeu1_4f_f - 12 * Eeu2_4f_f)},
        {6, 3, (-13 / 5) * (sqrt(3 / 14) * (Ma2u_4f_f - 3 * Meu_4f_f))},
        {6, -3, (13 / 5) * (sqrt(3 / 14) * (Ma2u_4f_f - 3 * Meu_4f_f))},
        {6, -6, (-13 / 20) * (sqrt(33 / 7) * (Ea1u_4f_f - Ea2uA_4f_f))},
        {6, 6, (-13 / 20) * (sqrt(33 / 7) * (Ea1u_4f_f - Ea2uA_4f_f))}
    }
...
G = GetResonantSpectrum(G, dZ_i, #T_2p_4f * #T_4d_2p, #Psis_i, NPoints1)
