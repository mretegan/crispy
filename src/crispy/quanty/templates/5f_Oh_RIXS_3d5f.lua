...
if CrystalFieldTerm then
    ...
    -- The seven 5f orbitals split into a2u + t1u + t2u; energies are referenced to
...
if LmctLigandsHybridizationTerm then
    ...
    E_5f_m = (28 * Delta_5f_L1_m - 460 * U_3d_5f_m - U_5f_5f_m * NElectrons_5f^2 - 47 * U_5f_5f_m * NElectrons_5f) / (2 * (NElectrons_5f + 24))
    E_3d_m = (28 * Delta_5f_L1_m - 2 * U_3d_5f_m * NElectrons_5f^2 - 30 * U_3d_5f_m * NElectrons_5f - 28 * U_3d_5f_m + U_5f_5f_m * NElectrons_5f^2 + U_5f_5f_m * NElectrons_5f) / (2 * (NElectrons_5f + 24))
    E_L1_m = (-2 * Delta_5f_L1_m * NElectrons_5f - 20 * Delta_5f_L1_m + 20 * U_3d_5f_m * NElectrons_5f + 20 * U_3d_5f_m + U_5f_5f_m * NElectrons_5f^2 + U_5f_5f_m * NElectrons_5f) / (2 * (NElectrons_5f + 24))

    Delta_5f_L1_f = $Delta(5f,L1)_f_value
    E_5f_f = (28 * Delta_5f_L1_f - 27 * U_5f_5f_f * NElectrons_5f - U_5f_5f_f * NElectrons_5f^2) / (2 * (14 + NElectrons_5f))
    E_L1_f = NElectrons_5f * (-2 * Delta_5f_L1_f + U_5f_5f_f * NElectrons_5f + U_5f_5f_f) / (2 * (NElectrons_5f + 14))
    ...
    Va2u_5f_L1_m = $Va2u(5f,L1)_m_value
    Vt1u_5f_L1_m = $Vt1u(5f,L1)_m_value
    Vt2u_5f_L1_m = $Vt2u(5f,L1)_m_value
    ...
    H_m = H_m + Chop(
        Va2u_5f_L1_m * Va2u_5f_L1
      + Vt1u_5f_L1_m * Vt1u_5f_L1
      + Vt2u_5f_L1_m * Vt2u_5f_L1)
...
if MlctLigandsHybridizationTerm then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_5f, N_3d, N_5f, N_L2, "dZ"}
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_3d>    <N_5f>    <N_L2>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end
