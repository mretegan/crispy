...
if CrystalFieldTerm then
    ...
    --
    -- The five 5d orbitals split into a1g + 2 eg. The two eg pairs descend from
    ...
    Akm = {{2, 0, 1}, {4, 0, 9 / 5}}
    Ea1g_5d = NewOperator("CF", NFermions, IndexUp_5d, IndexDn_5d, Akm)

    Akm = {{2, 0, 1}, {4, 0, -12 / 5}}
    Eegsigma_5d = NewOperator("CF", NFermions, IndexUp_5d, IndexDn_5d, Akm)

    Akm = {{2, 0, -2}, {4, 0, 3 / 5}}
    Eegpi_5d = NewOperator("CF", NFermions, IndexUp_5d, IndexDn_5d, Akm)

    Akm = {{4, -3, -3 * sqrt(7 / 5)}, {4, 3, 3 * sqrt(7 / 5)}}
    Meg_5d = NewOperator("CF", NFermions, IndexUp_5d, IndexDn_5d, Akm)

    Ea1g_5d_i = $Ea1g(5d)_i_value
    Eegsigma_5d_i = $Eegsigma(5d)_i_value
    Eegpi_5d_i = $Eegpi(5d)_i_value
    Meg_5d_i = $Meg(5d)_i_value
    ...
    Ea1g_5d_f = $Ea1g(5d)_f_value
    Eegsigma_5d_f = $Eegsigma(5d)_f_value
    Eegpi_5d_f = $Eegpi(5d)_f_value
    Meg_5d_f = $Meg(5d)_f_value

    H_i = H_i + Chop(
          Ea1g_5d_i * Ea1g_5d
        + Eegsigma_5d_i * Eegsigma_5d
        + Eegpi_5d_i * Eegpi_5d
        + Meg_5d_i * Meg_5d)

    H_f = H_f + Chop(
          Ea1g_5d_f * Ea1g_5d
        + Eegsigma_5d_f * Eegsigma_5d
        + Eegpi_5d_f * Eegpi_5d
        + Meg_5d_f * Meg_5d)
end
