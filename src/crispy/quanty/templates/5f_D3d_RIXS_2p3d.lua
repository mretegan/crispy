...
if CrystalFieldTerm then
    ...
    --
    -- The seven 5f orbitals (l = 3, ungerade) split into a1u + 2 a2u + 2 eu. The
    ...
    Eav_5f_i = ($Ea1u(5f)_i_value + $Ea2uA(5f)_i_value + $Ea2uB(5f)_i_value + 2 * $Eeu1(5f)_i_value + 2 * $Eeu2(5f)_i_value) / 7
    Ea1u_5f_i = $Ea1u(5f)_i_value - Eav_5f_i
    Ea2uA_5f_i = $Ea2uA(5f)_i_value - Eav_5f_i
    Ea2uB_5f_i = $Ea2uB(5f)_i_value - Eav_5f_i
    Eeu1_5f_i = $Eeu1(5f)_i_value - Eav_5f_i
    Eeu2_5f_i = $Eeu2(5f)_i_value - Eav_5f_i
    Ma2u_5f_i = $Ma2u(5f)_i_value
    Meu_5f_i = $Meu(5f)_i_value

    Akm_5f_i = {
        {0, 0, (1 / 7) * (Ea1u_5f_i + Ea2uA_5f_i + Ea2uB_5f_i + 2 * Eeu1_5f_i + 2 * Eeu2_5f_i)},
        {2, 0, (-5 / 28) * (5 * Ea1u_5f_i + 5 * Ea2uA_5f_i - 4 * Ea2uB_5f_i - 6 * Eeu1_5f_i)},
        {4, 0, (3 / 14) * (3 * Ea1u_5f_i + 3 * Ea2uA_5f_i + 2 * (3 * Ea2uB_5f_i + Eeu1_5f_i - 7 * Eeu2_5f_i))},
        {4, 3, (1 / sqrt(14)) * (9 * Ma2u_5f_i + 6 * Meu_5f_i)},
        {4, -3, -3 * (1 / sqrt(14)) * (3 * Ma2u_5f_i + 2 * Meu_5f_i)},
        {6, 0, (-13 / 140) * (Ea1u_5f_i + Ea2uA_5f_i - 20 * Ea2uB_5f_i + 30 * Eeu1_5f_i - 12 * Eeu2_5f_i)},
        {6, 3, (-13 / 5) * (sqrt(3 / 14) * (Ma2u_5f_i - 3 * Meu_5f_i))},
        {6, -3, (13 / 5) * (sqrt(3 / 14) * (Ma2u_5f_i - 3 * Meu_5f_i))},
        {6, -6, (-13 / 20) * (sqrt(33 / 7) * (Ea1u_5f_i - Ea2uA_5f_i))},
        {6, 6, (-13 / 20) * (sqrt(33 / 7) * (Ea1u_5f_i - Ea2uA_5f_i))}
    }
    ...
    Eav_5f_m = ($Ea1u(5f)_m_value + $Ea2uA(5f)_m_value + $Ea2uB(5f)_m_value + 2 * $Eeu1(5f)_m_value + 2 * $Eeu2(5f)_m_value) / 7
    Ea1u_5f_m = $Ea1u(5f)_m_value - Eav_5f_m
    Ea2uA_5f_m = $Ea2uA(5f)_m_value - Eav_5f_m
    Ea2uB_5f_m = $Ea2uB(5f)_m_value - Eav_5f_m
    Eeu1_5f_m = $Eeu1(5f)_m_value - Eav_5f_m
    Eeu2_5f_m = $Eeu2(5f)_m_value - Eav_5f_m
    Ma2u_5f_m = $Ma2u(5f)_m_value
    Meu_5f_m = $Meu(5f)_m_value

    Akm_5f_m = {
        {0, 0, (1 / 7) * (Ea1u_5f_m + Ea2uA_5f_m + Ea2uB_5f_m + 2 * Eeu1_5f_m + 2 * Eeu2_5f_m)},
        {2, 0, (-5 / 28) * (5 * Ea1u_5f_m + 5 * Ea2uA_5f_m - 4 * Ea2uB_5f_m - 6 * Eeu1_5f_m)},
        {4, 0, (3 / 14) * (3 * Ea1u_5f_m + 3 * Ea2uA_5f_m + 2 * (3 * Ea2uB_5f_m + Eeu1_5f_m - 7 * Eeu2_5f_m))},
        {4, 3, (1 / sqrt(14)) * (9 * Ma2u_5f_m + 6 * Meu_5f_m)},
        {4, -3, -3 * (1 / sqrt(14)) * (3 * Ma2u_5f_m + 2 * Meu_5f_m)},
        {6, 0, (-13 / 140) * (Ea1u_5f_m + Ea2uA_5f_m - 20 * Ea2uB_5f_m + 30 * Eeu1_5f_m - 12 * Eeu2_5f_m)},
        {6, 3, (-13 / 5) * (sqrt(3 / 14) * (Ma2u_5f_m - 3 * Meu_5f_m))},
        {6, -3, (13 / 5) * (sqrt(3 / 14) * (Ma2u_5f_m - 3 * Meu_5f_m))},
        {6, -6, (-13 / 20) * (sqrt(33 / 7) * (Ea1u_5f_m - Ea2uA_5f_m))},
        {6, 6, (-13 / 20) * (sqrt(33 / 7) * (Ea1u_5f_m - Ea2uA_5f_m))}
    }

    Eav_5f_f = ($Ea1u(5f)_f_value + $Ea2uA(5f)_f_value + $Ea2uB(5f)_f_value + 2 * $Eeu1(5f)_f_value + 2 * $Eeu2(5f)_f_value) / 7
    Ea1u_5f_f = $Ea1u(5f)_f_value - Eav_5f_f
    Ea2uA_5f_f = $Ea2uA(5f)_f_value - Eav_5f_f
    Ea2uB_5f_f = $Ea2uB(5f)_f_value - Eav_5f_f
    Eeu1_5f_f = $Eeu1(5f)_f_value - Eav_5f_f
    Eeu2_5f_f = $Eeu2(5f)_f_value - Eav_5f_f
    Ma2u_5f_f = $Ma2u(5f)_f_value
    Meu_5f_f = $Meu(5f)_f_value

    Akm_5f_f = {
        {0, 0, (1 / 7) * (Ea1u_5f_f + Ea2uA_5f_f + Ea2uB_5f_f + 2 * Eeu1_5f_f + 2 * Eeu2_5f_f)},
        {2, 0, (-5 / 28) * (5 * Ea1u_5f_f + 5 * Ea2uA_5f_f - 4 * Ea2uB_5f_f - 6 * Eeu1_5f_f)},
        {4, 0, (3 / 14) * (3 * Ea1u_5f_f + 3 * Ea2uA_5f_f + 2 * (3 * Ea2uB_5f_f + Eeu1_5f_f - 7 * Eeu2_5f_f))},
        {4, 3, (1 / sqrt(14)) * (9 * Ma2u_5f_f + 6 * Meu_5f_f)},
        {4, -3, -3 * (1 / sqrt(14)) * (3 * Ma2u_5f_f + 2 * Meu_5f_f)},
        {6, 0, (-13 / 140) * (Ea1u_5f_f + Ea2uA_5f_f - 20 * Ea2uB_5f_f + 30 * Eeu1_5f_f - 12 * Eeu2_5f_f)},
        {6, 3, (-13 / 5) * (sqrt(3 / 14) * (Ma2u_5f_f - 3 * Meu_5f_f))},
        {6, -3, (13 / 5) * (sqrt(3 / 14) * (Ma2u_5f_f - 3 * Meu_5f_f))},
        {6, -6, (-13 / 20) * (sqrt(33 / 7) * (Ea1u_5f_f - Ea2uA_5f_f))},
        {6, 6, (-13 / 20) * (sqrt(33 / 7) * (Ea1u_5f_f - Ea2uA_5f_f))}
    }
