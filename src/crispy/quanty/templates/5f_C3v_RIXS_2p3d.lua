...
if CrystalFieldTerm then
    ...
    -- inversion-related Quanty D3d "Zy" setting). The seven 5f orbitals split into
    ...
    Eav_5f_i = ($Ea2(5f)_i_value + $Ea1A(5f)_i_value + $Ea1B(5f)_i_value + 2 * $Ee1(5f)_i_value + 2 * $Ee2(5f)_i_value) / 7
    Ea2_5f_i = $Ea2(5f)_i_value - Eav_5f_i
    Ea1A_5f_i = $Ea1A(5f)_i_value - Eav_5f_i
    Ea1B_5f_i = $Ea1B(5f)_i_value - Eav_5f_i
    Ee1_5f_i = $Ee1(5f)_i_value - Eav_5f_i
    Ee2_5f_i = $Ee2(5f)_i_value - Eav_5f_i
    Ma1_5f_i = $Ma1(5f)_i_value
    Me_5f_i = $Me(5f)_i_value

    Akm_5f_i = {
        {0, 0, (1 / 7) * (Ea2_5f_i + Ea1A_5f_i + Ea1B_5f_i + 2 * Ee1_5f_i + 2 * Ee2_5f_i)},
        {2, 0, (-5 / 28) * (5 * Ea2_5f_i + 5 * Ea1A_5f_i - 4 * Ea1B_5f_i - 6 * Ee1_5f_i)},
        {4, 0, (3 / 14) * (3 * Ea2_5f_i + 3 * Ea1A_5f_i + 2 * (3 * Ea1B_5f_i + Ee1_5f_i - 7 * Ee2_5f_i))},
        {4, 3, (1 / sqrt(14)) * (9 * Ma1_5f_i + 6 * Me_5f_i)},
        {4, -3, -3 * (1 / sqrt(14)) * (3 * Ma1_5f_i + 2 * Me_5f_i)},
        {6, 0, (-13 / 140) * (Ea2_5f_i + Ea1A_5f_i - 20 * Ea1B_5f_i + 30 * Ee1_5f_i - 12 * Ee2_5f_i)},
        {6, 3, (-13 / 5) * (sqrt(3 / 14) * (Ma1_5f_i - 3 * Me_5f_i))},
        {6, -3, (13 / 5) * (sqrt(3 / 14) * (Ma1_5f_i - 3 * Me_5f_i))},
        {6, -6, (-13 / 20) * (sqrt(33 / 7) * (Ea2_5f_i - Ea1A_5f_i))},
        {6, 6, (-13 / 20) * (sqrt(33 / 7) * (Ea2_5f_i - Ea1A_5f_i))}
    }
    ...
    Eav_5f_m = ($Ea2(5f)_m_value + $Ea1A(5f)_m_value + $Ea1B(5f)_m_value + 2 * $Ee1(5f)_m_value + 2 * $Ee2(5f)_m_value) / 7
    Ea2_5f_m = $Ea2(5f)_m_value - Eav_5f_m
    Ea1A_5f_m = $Ea1A(5f)_m_value - Eav_5f_m
    Ea1B_5f_m = $Ea1B(5f)_m_value - Eav_5f_m
    Ee1_5f_m = $Ee1(5f)_m_value - Eav_5f_m
    Ee2_5f_m = $Ee2(5f)_m_value - Eav_5f_m
    Ma1_5f_m = $Ma1(5f)_m_value
    Me_5f_m = $Me(5f)_m_value

    Akm_5f_m = {
        {0, 0, (1 / 7) * (Ea2_5f_m + Ea1A_5f_m + Ea1B_5f_m + 2 * Ee1_5f_m + 2 * Ee2_5f_m)},
        {2, 0, (-5 / 28) * (5 * Ea2_5f_m + 5 * Ea1A_5f_m - 4 * Ea1B_5f_m - 6 * Ee1_5f_m)},
        {4, 0, (3 / 14) * (3 * Ea2_5f_m + 3 * Ea1A_5f_m + 2 * (3 * Ea1B_5f_m + Ee1_5f_m - 7 * Ee2_5f_m))},
        {4, 3, (1 / sqrt(14)) * (9 * Ma1_5f_m + 6 * Me_5f_m)},
        {4, -3, -3 * (1 / sqrt(14)) * (3 * Ma1_5f_m + 2 * Me_5f_m)},
        {6, 0, (-13 / 140) * (Ea2_5f_m + Ea1A_5f_m - 20 * Ea1B_5f_m + 30 * Ee1_5f_m - 12 * Ee2_5f_m)},
        {6, 3, (-13 / 5) * (sqrt(3 / 14) * (Ma1_5f_m - 3 * Me_5f_m))},
        {6, -3, (13 / 5) * (sqrt(3 / 14) * (Ma1_5f_m - 3 * Me_5f_m))},
        {6, -6, (-13 / 20) * (sqrt(33 / 7) * (Ea2_5f_m - Ea1A_5f_m))},
        {6, 6, (-13 / 20) * (sqrt(33 / 7) * (Ea2_5f_m - Ea1A_5f_m))}
    }

    Eav_5f_f = ($Ea2(5f)_f_value + $Ea1A(5f)_f_value + $Ea1B(5f)_f_value + 2 * $Ee1(5f)_f_value + 2 * $Ee2(5f)_f_value) / 7
    Ea2_5f_f = $Ea2(5f)_f_value - Eav_5f_f
    Ea1A_5f_f = $Ea1A(5f)_f_value - Eav_5f_f
    Ea1B_5f_f = $Ea1B(5f)_f_value - Eav_5f_f
    Ee1_5f_f = $Ee1(5f)_f_value - Eav_5f_f
    Ee2_5f_f = $Ee2(5f)_f_value - Eav_5f_f
    Ma1_5f_f = $Ma1(5f)_f_value
    Me_5f_f = $Me(5f)_f_value

    Akm_5f_f = {
        {0, 0, (1 / 7) * (Ea2_5f_f + Ea1A_5f_f + Ea1B_5f_f + 2 * Ee1_5f_f + 2 * Ee2_5f_f)},
        {2, 0, (-5 / 28) * (5 * Ea2_5f_f + 5 * Ea1A_5f_f - 4 * Ea1B_5f_f - 6 * Ee1_5f_f)},
        {4, 0, (3 / 14) * (3 * Ea2_5f_f + 3 * Ea1A_5f_f + 2 * (3 * Ea1B_5f_f + Ee1_5f_f - 7 * Ee2_5f_f))},
        {4, 3, (1 / sqrt(14)) * (9 * Ma1_5f_f + 6 * Me_5f_f)},
        {4, -3, -3 * (1 / sqrt(14)) * (3 * Ma1_5f_f + 2 * Me_5f_f)},
        {6, 0, (-13 / 140) * (Ea2_5f_f + Ea1A_5f_f - 20 * Ea1B_5f_f + 30 * Ee1_5f_f - 12 * Ee2_5f_f)},
        {6, 3, (-13 / 5) * (sqrt(3 / 14) * (Ma1_5f_f - 3 * Me_5f_f))},
        {6, -3, (13 / 5) * (sqrt(3 / 14) * (Ma1_5f_f - 3 * Me_5f_f))},
        {6, -6, (-13 / 20) * (sqrt(33 / 7) * (Ea2_5f_f - Ea1A_5f_f))},
        {6, 6, (-13 / 20) * (sqrt(33 / 7) * (Ea2_5f_f - Ea1A_5f_f))}
    }
...
T_2p_5f = {CalculateT({Txy_2p_5f, Txz_2p_5f, Tyz_2p_5f, Tx2y2_2p_5f, Tz2_2p_5f}, EpsIn, WaveVectorIn)}
...
G = GetResonantSpectrum(G, dZ_i, #T_2p_5f * #T_3d_2p, #Psis_i, NPoints1)
