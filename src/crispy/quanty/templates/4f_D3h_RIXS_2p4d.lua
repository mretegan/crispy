...
if CrystalFieldTerm then
    ...
    Eav_4f_m = ($Ea1p(4f)_m_value + $Ea2p(4f)_m_value + $Ea2pp(4f)_m_value + 2 * $Eep(4f)_m_value + 2 * $Eepp(4f)_m_value) / 7
    Ea1p_4f_m = $Ea1p(4f)_m_value - Eav_4f_m
    Ea2p_4f_m = $Ea2p(4f)_m_value - Eav_4f_m
    Ea2pp_4f_m = $Ea2pp(4f)_m_value - Eav_4f_m
    Eep_4f_m = $Eep(4f)_m_value - Eav_4f_m
    Eepp_4f_m = $Eepp(4f)_m_value - Eav_4f_m

    Akm_4f_m = {
        {0, 0, (1 / 7) * (Ea1p_4f_m + Ea2p_4f_m + Ea2pp_4f_m + 2 * Eep_4f_m + 2 * Eepp_4f_m)},
        {2, 0, (-5 / 28) * (5 * Ea1p_4f_m + 5 * Ea2p_4f_m - 4 * Ea2pp_4f_m - 6 * Eep_4f_m)},
        {4, 0, (3 / 14) * (3 * Ea1p_4f_m + 3 * Ea2p_4f_m + 2 * (3 * Ea2pp_4f_m + Eep_4f_m - 7 * Eepp_4f_m))},
        {6, 0, (-13 / 140) * (Ea1p_4f_m + Ea2p_4f_m - 20 * Ea2pp_4f_m + 30 * Eep_4f_m - 12 * Eepp_4f_m)},
        {6, -6, (13 / 20) * (sqrt(33 / 7) * (Ea1p_4f_m - Ea2p_4f_m))},
        {6, 6, (13 / 20) * (sqrt(33 / 7) * (Ea1p_4f_m - Ea2p_4f_m))}
    }
