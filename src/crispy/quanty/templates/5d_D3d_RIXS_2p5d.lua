...
if CrystalFieldTerm then
    ...
    Ea1g_5d_m = $Ea1g(5d)_m_value
    Eegsigma_5d_m = $Eegsigma(5d)_m_value
    Eegpi_5d_m = $Eegpi(5d)_m_value
    Meg_5d_m = $Meg(5d)_m_value
...
if ValueInTable("Resonant Inelastic", SpectraToCalculate) then
    T_2p_5d = {CalculateT({Tx_2p_5d, Ty_2p_5d, Tz_2p_5d}, EpsIn, WaveVectorIn)}
    T_5d_2p = {CalculateT({Tx_5d_2p, Ty_5d_2p, Tz_5d_2p}, EpsOut, WaveVectorOut)}
    ...
    G = GetResonantSpectrum(G, dZ_i, #T_2p_5d * #T_5d_2p, #Psis_i, NPoints1)
...
if ValueInTable("Isotropic Resonant Inelastic", SpectraToCalculate) then
    T_2p_5d = {Tx_2p_5d, Ty_2p_5d, Tz_2p_5d,
               (Tx_2p_5d + Ty_2p_5d) * t, (Tx_2p_5d + Tz_2p_5d) * t, (Ty_2p_5d + Tz_2p_5d) * t,
               (Tx_2p_5d - Ty_2p_5d) * t, (Tx_2p_5d - Tz_2p_5d) * t, (Ty_2p_5d - Tz_2p_5d) * t}
    T_5d_2p = {Tx_5d_2p, Ty_5d_2p, Tz_5d_2p,
               (Tx_5d_2p + Ty_5d_2p) * t, (Tx_5d_2p + Tz_5d_2p) * t, (Ty_5d_2p + Tz_5d_2p) * t,
               (Tx_5d_2p - Ty_5d_2p) * t, (Tx_5d_2p - Tz_5d_2p) * t, (Ty_5d_2p - Tz_5d_2p) * t}
