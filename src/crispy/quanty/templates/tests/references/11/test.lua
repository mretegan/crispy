...
if CrystalFieldTerm then
    -- C3v crystal field for f electrons. The seven 4f orbitals split
    -- into the a1, a2, e irreps; energies are referenced to their
    ...
    Eav_4f_i = (0.1 + 0.3 + -0.2 + 2 * 0.05 + 2 * -0.1) / 7
    Ea2_4f_i = 0.1 - Eav_4f_i
    Ea1A_4f_i = 0.3 - Eav_4f_i
    Ea1B_4f_i = -0.2 - Eav_4f_i
    Ee1_4f_i = 0.05 - Eav_4f_i
    Ee2_4f_i = -0.1 - Eav_4f_i
    Ma1_4f_i = 0.08
    Me_4f_i = 0.04
    ...
    Eav_4f_f = (0.1 + 0.3 + -0.2 + 2 * 0.05 + 2 * -0.1) / 7
    Ea2_4f_f = 0.1 - Eav_4f_f
    Ea1A_4f_f = 0.3 - Eav_4f_f
    Ea1B_4f_f = -0.2 - Eav_4f_f
    Ee1_4f_f = 0.05 - Eav_4f_f
    Ee2_4f_f = -0.1 - Eav_4f_f
    Ma1_4f_f = 0.08
    Me_4f_f = 0.04
