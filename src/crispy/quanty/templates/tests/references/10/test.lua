...
if CrystalFieldTerm then
    -- D3h crystal field for f electrons. The seven 4f orbitals split
    -- into the a1', a2', a2'', e', e'' irreps; energies are referenced to their
    ...
    Eav_4f_i = (0.2 + 0.1 + -0.2 + 2 * 0.05 + 2 * -0.1) / 7
    Ea1p_4f_i = 0.2 - Eav_4f_i
    Ea2p_4f_i = 0.1 - Eav_4f_i
    Ea2pp_4f_i = -0.2 - Eav_4f_i
    Eep_4f_i = 0.05 - Eav_4f_i
    Eepp_4f_i = -0.1 - Eav_4f_i
    ...
    Eav_4f_f = (0.2 + 0.1 + -0.2 + 2 * 0.05 + 2 * -0.1) / 7
    Ea1p_4f_f = 0.2 - Eav_4f_f
    Ea2p_4f_f = 0.1 - Eav_4f_f
    Ea2pp_4f_f = -0.2 - Eav_4f_f
    Eep_4f_f = 0.05 - Eav_4f_f
    Eepp_4f_f = -0.1 - Eav_4f_f
