...
NPsis = 14 -- Number of states to consider in the spectra calculation.
NPsisAuto = true -- Determine the number of state automatically.
NConfigurations = 1 -- Number of configurations.

Emin = 874.0 -- Minimum value of the energy range (eV).
Emax = 904.0 -- Maximum value of the energy range (eV).
NPoints = 2000 -- Number of points of the spectra.
ZeroShift = 7.4498 -- Shift that brings the edge or line energy to approximately zero (eV).
ExperimentalShift = 883.8 -- Experimental edge or line energy (eV).
Gaussian = 0.0 -- 0.1 -- Gaussian FWHM (eV).
Lorentzian = {{874.0, 0.87}, {904.0, 0.87}} -- Lorentzian FWHM (eV).
...
if AtomicTerm then
    ...
    U_4f_4f_f = 0.0
    F2_4f_4f_f = 12.6281 * 0.8
    F4_4f_4f_f = 7.9397 * 0.8
    F6_4f_4f_f = 5.7167 * 0.8
    F0_4f_4f_f = U_4f_4f_f + 4 / 195 * F2_4f_4f_f + 2 / 143 * F4_4f_4f_f + 100 / 5577 * F6_4f_4f_f
    U_3d_4f_f = 0.0
    F2_3d_4f_f = 7.4855 * 0.8
    F4_3d_4f_f = 3.3837 * 0.8
    G1_3d_4f_f = 5.0732 * 0.8
    G3_3d_4f_f = 2.9676 * 0.8
    G5_3d_4f_f = 2.0482 * 0.8
    ...
    zeta_4f_i = 0.0871 * 1.0

    zeta_4f_f = 0.1073 * 1.0
    zeta_3d_f = 7.446 * 1.0
...
if CrystalFieldTerm then
    -- D4h crystal field for f electrons. The seven 4f orbitals split
    -- into the a2u, b1u, b2u, eu irreps; energies are referenced to their
    ...
    Eav_4f_i = (0.3 + 0.1 + -0.1 + 2 * -0.2 + 2 * 0.15) / 7
    Ea2u_4f_i = 0.3 - Eav_4f_i
    Eb1u_4f_i = 0.1 - Eav_4f_i
    Eb2u_4f_i = -0.1 - Eav_4f_i
    Eeu1_4f_i = -0.2 - Eav_4f_i
    Eeu2_4f_i = 0.15 - Eav_4f_i
    Meu_4f_i = 0.05
    ...
    Eav_4f_f = (0.3 + 0.1 + -0.1 + 2 * -0.2 + 2 * 0.15) / 7
    Ea2u_4f_f = 0.3 - Eav_4f_f
    Eb1u_4f_f = 0.1 - Eav_4f_f
    Eb2u_4f_f = -0.1 - Eav_4f_f
    Eeu1_4f_f = -0.2 - Eav_4f_f
    Eeu2_4f_f = 0.15 - Eav_4f_f
    Meu_4f_f = 0.05
