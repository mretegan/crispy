...
if  CrystalFieldTerm then
    ...
    -- equatorial ligands sit on x and y, so b1g = d(x^2-y^2)). The five #f orbitals
...
if LmctLigandsHybridizationTerm then
    ...
    E_#f_f = (20 * Delta_#f_L1_f - U_#f_#f_f * NElectrons_#f^2 - 39 * U_#f_#f_f * NElectrons_#f - 380 * U_#i_#f_f) / (2 * NElectrons_#f + 40)
    E_#i_f = (20 * Delta_#f_L1_f + U_#f_#f_f * NElectrons_#f^2 + U_#f_#f_f * NElectrons_#f - 2 * U_#i_#f_f * NElectrons_#f^2 - 22 * U_#i_#f_f * NElectrons_#f - 20 * U_#i_#f_f) / (2 * NElectrons_#f + 40)
    E_L1_f = (-2 * Delta_#f_L1_f * NElectrons_#f - 20 * Delta_#f_L1_f + U_#f_#f_f * NElectrons_#f^2 + U_#f_#f_f * NElectrons_#f + 20 * U_#i_#f_f * NElectrons_#f + 20 * U_#i_#f_f) / (2 * NElectrons_#f + 40)    
...
if MlctLigandsHybridizationTerm then
    ...
    E_#f_f = (-U_#f_#f_f * NElectrons_#f^2 - 19 * U_#f_#f_f * NElectrons_#f - 180 * U_#i_#f_f) / (2 * NElectrons_#f + 20) 
    E_#i_f = (U_#f_#f_f * NElectrons_#f^2 + U_#f_#f_f * NElectrons_#f - 2 * U_#i_#f_f * NElectrons_#f^2 - 2 * U_#i_#f_f * NElectrons_#f) / (2 * NElectrons_#f + 20)
    E_L2_f = (2 * Delta_#f_L2_f * NElectrons_#f + 20 * Delta_#f_L2_f + U_#f_#f_f * NElectrons_#f^2 - U_#f_#f_f * NElectrons_#f - 20 * U_#f_#f_f + 20 * U_#i_#f_f * NElectrons_#f + 20 * U_#i_#f_f) / (2 * NElectrons_#f + 20)   
