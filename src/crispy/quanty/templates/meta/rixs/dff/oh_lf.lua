...
if CrystalFieldTerm then
    ...
    Eav_#f_m = ($Ea2u(#f)_m_value + 3 * $Et1u(#f)_m_value + 3 * $Et2u(#f)_m_value) / 7
    Ea2u_#f_m = $Ea2u(#f)_m_value - Eav_#f_m
    Et1u_#f_m = $Et1u(#f)_m_value - Eav_#f_m
    Et2u_#f_m = $Et2u(#f)_m_value - Eav_#f_m

    Akm_#f_m = {
        {0, 0, (1 / 7) * (Ea2u_#f_m + (3) * (Et1u_#f_m + Et2u_#f_m))},
        {4, 0, (-3 / 4) * ((2) * (Ea2u_#f_m) + (-3) * (Et1u_#f_m) + Et2u_#f_m)},
        {4, -4, (-3 / 4) * ((sqrt(5 / 14)) * ((2) * (Ea2u_#f_m) + (-3) * (Et1u_#f_m) + Et2u_#f_m))},
        {4, 4, (-3 / 4) * ((sqrt(5 / 14)) * ((2) * (Ea2u_#f_m) + (-3) * (Et1u_#f_m) + Et2u_#f_m))},
        {6, 0, (39 / 280) * ((4) * (Ea2u_#f_m) + (5) * (Et1u_#f_m) + (-9) * (Et2u_#f_m))},
        {6, -4, (-39 / 40) * ((1 / (sqrt(14))) * ((4) * (Ea2u_#f_m) + (5) * (Et1u_#f_m) + (-9) * (Et2u_#f_m)))},
        {6, 4, (-39 / 40) * ((1 / (sqrt(14))) * ((4) * (Ea2u_#f_m) + (5) * (Et1u_#f_m) + (-9) * (Et2u_#f_m)))}
    }
    ...
    H_m = H_m + Chop(NewOperator("CF", NFermions, IndexUp_#f, IndexDn_#f, Akm_#f_m))
...
if LmctLigandsHybridizationTerm then
    ...
    Delta_#f_L1_m = $Delta(#f,L1)_m_value
    E_#f_m = (28 * Delta_#f_L1_m - 460 * U_#i_#f_m - U_#f_#f_m * NElectrons_#f^2 - 47 * U_#f_#f_m * NElectrons_#f) / (2 * (NElectrons_#f + 24))
    E_#i_m = (28 * Delta_#f_L1_m - 2 * U_#i_#f_m * NElectrons_#f^2 - 30 * U_#i_#f_m * NElectrons_#f - 28 * U_#i_#f_m + U_#f_#f_m * NElectrons_#f^2 + U_#f_#f_m * NElectrons_#f) / (2 * (NElectrons_#f + 24))
    E_L1_m = (-2 * Delta_#f_L1_m * NElectrons_#f - 20 * Delta_#f_L1_m + 20 * U_#i_#f_m * NElectrons_#f + 20 * U_#i_#f_m + U_#f_#f_m * NElectrons_#f^2 + U_#f_#f_m * NElectrons_#f) / (2 * (NElectrons_#f + 24))

    Delta_#f_L1_f = $Delta(#f,L1)_f_value
    E_#f_f = (28 * Delta_#f_L1_f - 27 * U_#f_#f_f * NElectrons_#f - U_#f_#f_f * NElectrons_#f^2) / (2 * (14 + NElectrons_#f))
    E_L1_f = NElectrons_#f * (-2 * Delta_#f_L1_f + U_#f_#f_f * NElectrons_#f + U_#f_#f_f) / (2 * (NElectrons_#f + 14))
    ...
    Va2u_#f_L1_m = $Va2u(#f,L1)_m_value
    Vt1u_#f_L1_m = $Vt1u(#f,L1)_m_value
    Vt2u_#f_L1_m = $Vt2u(#f,L1)_m_value
    ...
    H_m = H_m + Chop(
        Va2u_#f_L1_m * Va2u_#f_L1
      + Vt1u_#f_L1_m * Vt1u_#f_L1
      + Vt2u_#f_L1_m * Vt2u_#f_L1)
