...
IndexDn_5d = {10, 12, 14, 16, 18}
IndexUp_5d = {11, 13, 15, 17, 19}
...
if LmctLigandsHybridizationTerm then
    ...
    IndexDn_L1 = {20, 22, 24, 26, 28}
    IndexUp_L1 = {21, 23, 25, 27, 29}
end
...
if MlctLigandsHybridizationTerm then
    ...
    IndexDn_L2 = {20, 22, 24, 26, 28}
    IndexUp_L2 = {21, 23, 25, 27, 29}
end
...
if AtomicTerm then
    ...
    F0_4d_5d = NewOperator("U", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_5d, IndexDn_5d, {1, 0, 0}, {0, 0, 0})
    F2_4d_5d = NewOperator("U", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_5d, IndexDn_5d, {0, 1, 0}, {0, 0, 0})
    F4_4d_5d = NewOperator("U", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_5d, IndexDn_5d, {0, 0, 1}, {0, 0, 0})
    G0_4d_5d = NewOperator("U", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_5d, IndexDn_5d, {0, 0, 0}, {1, 0, 0})
    G2_4d_5d = NewOperator("U", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_5d, IndexDn_5d, {0, 0, 0}, {0, 1, 0})
    G4_4d_5d = NewOperator("U", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_5d, IndexDn_5d, {0, 0, 0}, {0, 0, 1})
    ...
    U_4d_5d_f = $U(4d,5d)_f_value
    F2_4d_5d_f = $F2(4d,5d)_f_value * $F2(4d,5d)_f_scaleFactor
    F4_4d_5d_f = $F4(4d,5d)_f_value * $F4(4d,5d)_f_scaleFactor
    G0_4d_5d_f = $G0(4d,5d)_f_value * $G0(4d,5d)_f_scaleFactor
    G2_4d_5d_f = $G2(4d,5d)_f_value * $G2(4d,5d)_f_scaleFactor
    G4_4d_5d_f = $G4(4d,5d)_f_value * $G4(4d,5d)_f_scaleFactor
    F0_4d_5d_f = U_4d_5d_f + 1 / 10 * G0_4d_5d_f + 1 / 35 * G2_4d_5d_f + 1 / 35 * G4_4d_5d_f
...
if CrystalFieldTerm then
    ...
    -- the C3 axes along the cube diagonals [+-1, +-1, +-1]. The five 5d orbitals
...
if LmctLigandsHybridizationTerm then
    ...
    E_5d_f = (20 * Delta_5d_L1_f - U_5d_5d_f * NElectrons_5d^2 - 39 * U_5d_5d_f * NElectrons_5d - 380 * U_4d_5d_f) / (2 * NElectrons_5d + 40)
    E_4d_f = (20 * Delta_5d_L1_f + U_5d_5d_f * NElectrons_5d^2 + U_5d_5d_f * NElectrons_5d - 2 * U_4d_5d_f * NElectrons_5d^2 - 22 * U_4d_5d_f * NElectrons_5d - 20 * U_4d_5d_f) / (2 * NElectrons_5d + 40)
    E_L1_f = (-2 * Delta_5d_L1_f * NElectrons_5d - 20 * Delta_5d_L1_f + U_5d_5d_f * NElectrons_5d^2 + U_5d_5d_f * NElectrons_5d + 20 * U_4d_5d_f * NElectrons_5d + 20 * U_4d_5d_f) / (2 * NElectrons_5d + 40)    
...
if MlctLigandsHybridizationTerm then
    ...
    E_5d_f = (-U_5d_5d_f * NElectrons_5d^2 - 19 * U_5d_5d_f * NElectrons_5d - 180 * U_4d_5d_f) / (2 * NElectrons_5d + 20) 
    E_4d_f = (U_5d_5d_f * NElectrons_5d^2 + U_5d_5d_f * NElectrons_5d - 2 * U_4d_5d_f * NElectrons_5d^2 - 2 * U_4d_5d_f * NElectrons_5d) / (2 * NElectrons_5d + 20)
    E_L2_f = (2 * Delta_5d_L2_f * NElectrons_5d + 20 * Delta_5d_L2_f + U_5d_5d_f * NElectrons_5d^2 - U_5d_5d_f * NElectrons_5d - 20 * U_5d_5d_f + 20 * U_4d_5d_f * NElectrons_5d + 20 * U_4d_5d_f) / (2 * NElectrons_5d + 20)     
...
--------------------------------------------------------------------------------
InitialRestrictions = {NFermions, NBosons, {"1111111111 0000000000", NElectrons_4d, NElectrons_4d},
                                           {"0000000000 1111111111", NElectrons_5d, NElectrons_5d}}

FinalRestrictions = {NFermions, NBosons, {"1111111111 0000000000", NElectrons_4d - 1, NElectrons_4d - 1},
                                         {"0000000000 1111111111", NElectrons_5d, NElectrons_5d}}

CalculationRestrictions = nil

if LmctLigandsHybridizationTerm then
    InitialRestrictions = {NFermions, NBosons, {"1111111111 0000000000 0000000000", NElectrons_4d, NElectrons_4d},
                                               {"0000000000 1111111111 0000000000", NElectrons_5d, NElectrons_5d},
                                               {"0000000000 0000000000 1111111111", NElectrons_L1, NElectrons_L1}}

    FinalRestrictions = {NFermions, NBosons, {"1111111111 0000000000 0000000000", NElectrons_4d - 1, NElectrons_4d - 1},
                                             {"0000000000 1111111111 0000000000", NElectrons_5d, NElectrons_5d},
                                             {"0000000000 0000000000 1111111111", NElectrons_L1, NElectrons_L1}}
...
Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_5d, N_4d, N_5d, "dZ"}
Header = "Analysis of the %s Hamiltonian:\n"
Header = Header .. "=================================================================================================================================\n"
Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_4d>    <N_5d>          dZ\n"
Header = Header .. "=================================================================================================================================\n"
Footer = "=================================================================================================================================\n"

if LmctLigandsHybridizationTerm then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_5d, N_4d, N_5d, N_L1, "dZ"}
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_4d>    <N_5d>    <N_L1>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end

if MlctLigandsHybridizationTerm then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_5d, N_4d, N_5d, N_L2, "dZ"}
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_4d>    <N_5d>    <N_L2>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end
...
for i = 1, NElectrons_4d / 2 do
    T_4d_5d[2*i - 1] = NewOperator("An", NFermions, IndexDn_4d[i])
    T_4d_5d[2*i]     = NewOperator("An", NFermions, IndexUp_4d[i])
end
...
if CalculationRestrictions == nil then
    G_4d_5d = CreateSpectra(H_f, T_4d_5d, Psis_i, {{"Emin", Emin}, {"Emax", Emax}, {"NE", NPoints}, {"Gamma", Gamma}, {"DenseBorder", DenseBorder}})
else
    G_4d_5d = CreateSpectra(H_f, T_4d_5d, Psis_i, {{"Emin", Emin}, {"Emax", Emax}, {"NE", NPoints}, {"Gamma", Gamma}, {"Restrictions", CalculationRestrictions}, {"DenseBorder", DenseBorder}})
end

if ShiftSpectra then
    G_4d_5d.Shift(ZeroShift + ExperimentalShift)
end

-- Create a list with the Boltzmann probabilities for a given operator and wavefunction.
local dZ_4d_5d = {}
for _ in ipairs(T_4d_5d) do
    for j in ipairs(Psis_i) do
        table.insert(dZ_4d_5d, dZ_i[j])
    end
end
...
if ValueInTable(Spectrum, SpectraToCalculate) then
    SpectrumIds = {}
    c = 1
    for i, Operator in ipairs(T_4d_5d) do
        table.insert(SpectrumIds, c)
        c = c + 1
    end

    Giso = GetSpectrum(G_4d_5d, SpectrumIds, dZ_4d_5d, #T_4d_5d, #Psis_i)
