...
if AtomicTerm then
    ...
    F0_3d_5d = NewOperator("U", NFermions, IndexUp_3d, IndexDn_3d, IndexUp_5d, IndexDn_5d, {1, 0, 0}, {0, 0, 0})
    F2_3d_5d = NewOperator("U", NFermions, IndexUp_3d, IndexDn_3d, IndexUp_5d, IndexDn_5d, {0, 1, 0}, {0, 0, 0})
    F4_3d_5d = NewOperator("U", NFermions, IndexUp_3d, IndexDn_3d, IndexUp_5d, IndexDn_5d, {0, 0, 1}, {0, 0, 0})
    G0_3d_5d = NewOperator("U", NFermions, IndexUp_3d, IndexDn_3d, IndexUp_5d, IndexDn_5d, {0, 0, 0}, {1, 0, 0})
    G2_3d_5d = NewOperator("U", NFermions, IndexUp_3d, IndexDn_3d, IndexUp_5d, IndexDn_5d, {0, 0, 0}, {0, 1, 0})
    G4_3d_5d = NewOperator("U", NFermions, IndexUp_3d, IndexDn_3d, IndexUp_5d, IndexDn_5d, {0, 0, 0}, {0, 0, 1})
    ...
    U_3d_5d_f = $U(3d,5d)_f_value
    F2_3d_5d_f = $F2(3d,5d)_f_value * $F2(3d,5d)_f_scaleFactor
    F4_3d_5d_f = $F4(3d,5d)_f_value * $F4(3d,5d)_f_scaleFactor
    G0_3d_5d_f = $G0(3d,5d)_f_value * $G0(3d,5d)_f_scaleFactor
    G2_3d_5d_f = $G2(3d,5d)_f_value * $G2(3d,5d)_f_scaleFactor
    G4_3d_5d_f = $G4(3d,5d)_f_value * $G4(3d,5d)_f_scaleFactor
    F0_3d_5d_f = U_3d_5d_f + 1 / 10 * G0_3d_5d_f + 1 / 35 * G2_3d_5d_f + 1 / 35 * G4_3d_5d_f
...
if LmctLigandsHybridizationTerm then
    ...
    E_5d_f = (20 * Delta_5d_L1_f - U_5d_5d_f * NElectrons_5d^2 - 39 * U_5d_5d_f * NElectrons_5d - 380 * U_3d_5d_f) / (2 * NElectrons_5d + 40)
    E_3d_f = (20 * Delta_5d_L1_f + U_5d_5d_f * NElectrons_5d^2 + U_5d_5d_f * NElectrons_5d - 2 * U_3d_5d_f * NElectrons_5d^2 - 22 * U_3d_5d_f * NElectrons_5d - 20 * U_3d_5d_f) / (2 * NElectrons_5d + 40)
    E_L1_f = (-2 * Delta_5d_L1_f * NElectrons_5d - 20 * Delta_5d_L1_f + U_5d_5d_f * NElectrons_5d^2 + U_5d_5d_f * NElectrons_5d + 20 * U_3d_5d_f * NElectrons_5d + 20 * U_3d_5d_f) / (2 * NElectrons_5d + 40)    
...
if MlctLigandsHybridizationTerm then
    ...
    E_5d_f = (-U_5d_5d_f * NElectrons_5d^2 - 19 * U_5d_5d_f * NElectrons_5d - 180 * U_3d_5d_f) / (2 * NElectrons_5d + 20) 
    E_3d_f = (U_5d_5d_f * NElectrons_5d^2 + U_5d_5d_f * NElectrons_5d - 2 * U_3d_5d_f * NElectrons_5d^2 - 2 * U_3d_5d_f * NElectrons_5d) / (2 * NElectrons_5d + 20)
    E_L2_f = (2 * Delta_5d_L2_f * NElectrons_5d + 20 * Delta_5d_L2_f + U_5d_5d_f * NElectrons_5d^2 - U_5d_5d_f * NElectrons_5d - 20 * U_5d_5d_f + 20 * U_3d_5d_f * NElectrons_5d + 20 * U_3d_5d_f) / (2 * NElectrons_5d + 20)     
...
--------------------------------------------------------------------------------
InitialRestrictions = {NFermions, NBosons, {"1111111111 0000000000", NElectrons_3d, NElectrons_3d},
                                           {"0000000000 1111111111", NElectrons_5d, NElectrons_5d}}

FinalRestrictions = {NFermions, NBosons, {"1111111111 0000000000", NElectrons_3d - 1, NElectrons_3d - 1},
                                         {"0000000000 1111111111", NElectrons_5d, NElectrons_5d}}

CalculationRestrictions = nil

if LmctLigandsHybridizationTerm then
    InitialRestrictions = {NFermions, NBosons, {"1111111111 0000000000 0000000000", NElectrons_3d, NElectrons_3d},
                                               {"0000000000 1111111111 0000000000", NElectrons_5d, NElectrons_5d},
                                               {"0000000000 0000000000 1111111111", NElectrons_L1, NElectrons_L1}}

    FinalRestrictions = {NFermions, NBosons, {"1111111111 0000000000 0000000000", NElectrons_3d - 1, NElectrons_3d - 1},
                                             {"0000000000 1111111111 0000000000", NElectrons_5d, NElectrons_5d},
                                             {"0000000000 0000000000 1111111111", NElectrons_L1, NElectrons_L1}}
...
Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_5d, N_3d, N_5d, "dZ"}
Header = "Analysis of the %s Hamiltonian:\n"
Header = Header .. "=================================================================================================================================\n"
Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_3d>    <N_5d>          dZ\n"
Header = Header .. "=================================================================================================================================\n"
Footer = "=================================================================================================================================\n"

if LmctLigandsHybridizationTerm then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_5d, N_3d, N_5d, N_L1, "dZ"}
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_3d>    <N_5d>    <N_L1>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end

if MlctLigandsHybridizationTerm then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_5d, N_3d, N_5d, N_L2, "dZ"}
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_3d>    <N_5d>    <N_L2>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end
...
for i = 1, NElectrons_3d / 2 do
    T_3d_5d[2*i - 1] = NewOperator("An", NFermions, IndexDn_3d[i])
    T_3d_5d[2*i]     = NewOperator("An", NFermions, IndexUp_3d[i])
end
...
if CalculationRestrictions == nil then
    G_3d_5d = CreateSpectra(H_f, T_3d_5d, Psis_i, {{"Emin", Emin}, {"Emax", Emax}, {"NE", NPoints}, {"Gamma", Gamma}, {"DenseBorder", DenseBorder}})
else
    G_3d_5d = CreateSpectra(H_f, T_3d_5d, Psis_i, {{"Emin", Emin}, {"Emax", Emax}, {"NE", NPoints}, {"Gamma", Gamma}, {"Restrictions", CalculationRestrictions}, {"DenseBorder", DenseBorder}})
end

if ShiftSpectra then
    G_3d_5d.Shift(ZeroShift + ExperimentalShift)
end

-- Create a list with the Boltzmann probabilities for a given operator and wavefunction.
local dZ_3d_5d = {}
for _ in ipairs(T_3d_5d) do
    for j in ipairs(Psis_i) do
        table.insert(dZ_3d_5d, dZ_i[j])
    end
end
...
if ValueInTable(Spectrum, SpectraToCalculate) then
    SpectrumIds = {}
    c = 1
    for i, Operator in ipairs(T_3d_5d) do
        table.insert(SpectrumIds, c)
        c = c + 1
    end

    Giso = GetSpectrum(G_3d_5d, SpectrumIds, dZ_3d_5d, #T_3d_5d, #Psis_i)
