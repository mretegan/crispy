...
IndexDn_4d = {10, 12, 14, 16, 18}
IndexUp_4d = {11, 13, 15, 17, 19}
...
if AtomicTerm then
    ...
    U_3d_4d_f = $U(3d,4d)_f_value
    F2_3d_4d_f = $F2(3d,4d)_f_value * $F2(3d,4d)_f_scaleFactor
    F4_3d_4d_f = $F4(3d,4d)_f_value * $F4(3d,4d)_f_scaleFactor
    G0_3d_4d_f = $G0(3d,4d)_f_value * $G0(3d,4d)_f_scaleFactor
    G2_3d_4d_f = $G2(3d,4d)_f_value * $G2(3d,4d)_f_scaleFactor
    G4_3d_4d_f = $G4(3d,4d)_f_value * $G4(3d,4d)_f_scaleFactor
    F0_3d_4d_f = U_3d_4d_f + 1 / 10 * G0_3d_4d_f + 1 / 35 * G2_3d_4d_f + 1 / 35 * G4_3d_4d_f
...
if  CrystalFieldTerm then
    ...
    -- equatorial ligands sit on x and y, so b1g = d(x^2-y^2)). The five 4d orbitals
...
InitialRestrictions = {NFermions, NBosons, {"1111111111 0000000000", NElectrons_3d, NElectrons_3d},
                                           {"0000000000 1111111111", NElectrons_4d, NElectrons_4d}}
...
if LmctLigandsHybridizationTerm then
    InitialRestrictions = {NFermions, NBosons, {"1111111111 0000000000 0000000000", NElectrons_3d, NElectrons_3d},
                                               {"0000000000 1111111111 0000000000", NElectrons_4d, NElectrons_4d},
...
Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_4d, N_3d, N_4d, "dZ"}
Header = "Analysis of the %s Hamiltonian:\n"
Header = Header .. "=================================================================================================================================\n"
Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_3d>    <N_4d>          dZ\n"
Header = Header .. "=================================================================================================================================\n"
Footer = "=================================================================================================================================\n"

if LmctLigandsHybridizationTerm then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_4d, N_3d, N_4d, N_L1, "dZ"}
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_3d>    <N_4d>    <N_L1>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end

if MlctLigandsHybridizationTerm then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_4d, N_3d, N_4d, N_L2, "dZ"}
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_3d>    <N_4d>    <N_L2>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end
...
for i = 1, NElectrons_3d / 2 do
    T_3d_4d[2*i - 1] = NewOperator("An", NFermions, IndexDn_3d[i])
    T_3d_4d[2*i]     = NewOperator("An", NFermions, IndexUp_3d[i])
end
...
if CalculationRestrictions == nil then
    G_3d_4d = CreateSpectra(H_f, T_3d_4d, Psis_i, {{"Emin", Emin}, {"Emax", Emax}, {"NE", NPoints}, {"Gamma", Gamma}, {"DenseBorder", DenseBorder}})
else
    G_3d_4d = CreateSpectra(H_f, T_3d_4d, Psis_i, {{"Emin", Emin}, {"Emax", Emax}, {"NE", NPoints}, {"Gamma", Gamma}, {"Restrictions", CalculationRestrictions}, {"DenseBorder", DenseBorder}})
end

if ShiftSpectra then
    G_3d_4d.Shift(ZeroShift + ExperimentalShift)
end

-- Create a list with the Boltzmann probabilities for a given operator and wavefunction.
local dZ_3d_4d = {}
for _ in ipairs(T_3d_4d) do
    for j in ipairs(Psis_i) do
        table.insert(dZ_3d_4d, dZ_i[j])
    end
end
...
if ValueInTable(Spectrum, SpectraToCalculate) then
    SpectrumIds = {}
    c = 1
    for i, Operator in ipairs(T_3d_4d) do
        table.insert(SpectrumIds, c)
        c = c + 1
    end

    Giso = GetSpectrum(G_3d_4d, SpectrumIds, dZ_3d_4d, #T_3d_4d, #Psis_i)
