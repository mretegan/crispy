...
if CrystalFieldTerm then
    ...
    Eav_5f_m = ($Ea2u(5f)_m_value + $Eb1u(5f)_m_value + $Eb2u(5f)_m_value + 2 * $Eeu1(5f)_m_value + 2 * $Eeu2(5f)_m_value) / 7
    Ea2u_5f_m = $Ea2u(5f)_m_value - Eav_5f_m
    Eb1u_5f_m = $Eb1u(5f)_m_value - Eav_5f_m
    Eb2u_5f_m = $Eb2u(5f)_m_value - Eav_5f_m
    Eeu1_5f_m = $Eeu1(5f)_m_value - Eav_5f_m
    Eeu2_5f_m = $Eeu2(5f)_m_value - Eav_5f_m
    Meu_5f_m = $Meu(5f)_m_value

    Akm_5f_m = {
        {0, 0, (1 / 7) * (Ea2u_5f_m + Eb1u_5f_m + Eb2u_5f_m + 2 * Eeu1_5f_m + 2 * Eeu2_5f_m)},
        {2, 0, (5 / 7) * (Ea2u_5f_m - Eeu1_5f_m + sqrt(15) * Meu_5f_m)},
        {4, 0, (3 / 28) * (12 * Ea2u_5f_m - 14 * Eb1u_5f_m - 14 * Eb2u_5f_m + 9 * Eeu1_5f_m + 7 * Eeu2_5f_m - 2 * sqrt(15) * Meu_5f_m)},
        {4, -4, (-3 / 56) * (2 * sqrt(70) * Eb1u_5f_m - 2 * sqrt(70) * Eb2u_5f_m - 3 * sqrt(70) * Eeu1_5f_m + 3 * sqrt(70) * Eeu2_5f_m - 2 * sqrt(42) * Meu_5f_m)},
        {4, 4, (-3 / 56) * (2 * sqrt(70) * Eb1u_5f_m - 2 * sqrt(70) * Eb2u_5f_m - 3 * sqrt(70) * Eeu1_5f_m + 3 * sqrt(70) * Eeu2_5f_m - 2 * sqrt(42) * Meu_5f_m)},
        {6, 0, (13 / 280) * (40 * Ea2u_5f_m + 12 * Eb1u_5f_m + 12 * Eb2u_5f_m - 25 * Eeu1_5f_m - 39 * Eeu2_5f_m - 14 * sqrt(15) * Meu_5f_m)},
        {6, -4, (-13 / 560) * (sqrt(3) * (4 * sqrt(42) * Eb1u_5f_m - 4 * sqrt(42) * Eb2u_5f_m + 5 * sqrt(42) * Eeu1_5f_m - 5 * sqrt(42) * Eeu2_5f_m + 2 * sqrt(70) * Meu_5f_m))},
        {6, 4, (-13 / 560) * (sqrt(3) * (4 * sqrt(42) * Eb1u_5f_m - 4 * sqrt(42) * Eb2u_5f_m + 5 * sqrt(42) * Eeu1_5f_m - 5 * sqrt(42) * Eeu2_5f_m + 2 * sqrt(70) * Meu_5f_m))}
    }
